...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        # #left superior
        # out1 = self.fc1(x[:,:,0,0].view(act_batch_size,-1))

        # #right mid
        # out2 = self.fc2(x[:,:,1,1].view(act_batch_size,-1))

        # #left mid
        # out3 = self.fc3(x[:,:,1,0].view(act_batch_size,-1))

        # #right inf
        # out4 = self.fc4(x[:,:,2,1].view(act_batch_size,-1))

        # #left inf
        # out5 = self.fc5(x[:,:,2,0].view(act_batch_size,-1))
