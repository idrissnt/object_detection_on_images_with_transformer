...
parser.add_argument('--model', type=str, default='Rad_Dino',
                    help='model name, options: [Rad_Dino, ResNet, initial_vit]')
...
if __name__ == '__main__':
    ...
    # # model_names = ['Rad_Dino', 'ResNet', 'initial_vit']    
    # # for model_nam in model_names:

    experiment_path = f'{args.experiment_path}{args.model}'
    # experiment_path = f'{args.experiment_path}{model_nam}'
    ...
    batch_train_data, batch_val_data, batch_test_data, all_class_weights = get_data(args.batch_size)
    ...
    #     logging.info("Epoch {}/{}".format(epoch + 1, 50))

    #     logging.info("Training and Validating...")
    #     train_loss, val_loss, model_optimizer, model, loss_fn = main_exp.train_and_validation(batch_train_data, batch_val_data, all_class_weights)
